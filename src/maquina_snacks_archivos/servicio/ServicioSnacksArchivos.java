...
public class ServicioSnacksArchivos implements IServicioSnacks{
    ...
    public void agregarSnack(Snack snack) {
        // Implementación para agregar un snack a un archivo
    ...
    private void agregarSnackArchivo(Snack snack){
        ...
        try {
            ...
            System.out.println("Error al cargar snack: " + e.getMessage());
        }
    }

    @Override
    public void mostrarSnacks() {
        // Implementación para mostrar los snacks desde un archivo
    ...
    public List<Snack> getSnacks() {
        // Implementación para obtener la lista de snacks desde un archivo
        return this.snacks;
    }
